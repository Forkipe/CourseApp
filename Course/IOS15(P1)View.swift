                ...
                VStack{
                    ...
                    ZStack{
                        RoundedRectangle(cornerRadius: 20)
                            .stroke(lineWidth: 2)
                            .foregroundStyle(.linearGradient(colors: [.green, .black], startPoint: .bottom, endPoint: .trailing))
                            .offset(y:-130)
                    ...
                    ZStack{
                        RoundedRectangle(cornerRadius: 10).foregroundStyle(.thinMaterial)
                            ...
                            .foregroundStyle(
                                .linearGradient(colors: [.init(red: 0.4, green: 0.4, blue: 0.4, opacity: 0.4), .init(red: 0.4, green: 0.4, blue: 0.4, opacity: 0.4)], startPoint: .top, endPoint: .trailing))
                    ...
                    NavigationLink(destination:SwiftUIAppP1().navigationBarBackButtonHidden(true)){
                        RoundedRectangle(cornerRadius: 10)
                            .foregroundStyle(.linearGradient(
                            colors: [.init(red: 0, green: 1, blue: 0, opacity: 0.2)], startPoint: .top, endPoint: .trailing))
