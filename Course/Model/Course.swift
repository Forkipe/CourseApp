...
var courses = [
    ...
    Course(index: 2, title: "SwiftUI Combine and Data", subtitle: "18 SECTIONS - 3 HOURS OF VIDEO", text: "Learn about Combine, the MVVM architecture, data, notifications and performance hands-on by creating a beautiful SwiftUI application", image: "Illustration 3", background: "Background 4", logo: "Logo 2"),
    ...
    Course(index: 5, title: "Advanced Development in SwiftUI", subtitle: "20 SECTIONS - 4 HOURS OF VIDEO", text: "Advance your SwiftUI skills by developing an app using Core Data, CloudKit, In App Purchases...", image: "Illustration 2", background: "Background 2", logo: "Logo 2")
]
...
var featuredCourses = [
    ...
    Course(index: 5, title: "Advanced Development in SwiftUI", subtitle: "20 SECTIONS - 4 HOURS OF VIDEO", text: "Advance your SwiftUI skills by developing an app using Core Data, CloudKit, In App Purchases, Sign In With Apple, and Firebase Authentication", image: "Illustration 5", background: "Background 7", logo: "Logo 2")
]
